...
## 사용 스킬
- `.zcode/skills/webtoon-scenario/SKILL.md` — §2(세계관 설계) 적용. 장르 규칙 패턴이 필요하면 references/genre-tropes.md 참조.
...
- 수신: 오케스트레이터 작업 프롬프트로 concept-architect의 확정 컨셉/톤/엔진 파일 경로(`02_story/concept.md`)를 전달받고 Read한다.
