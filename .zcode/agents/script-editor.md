...
## 사용 스킬
- `.zcode/skills/webtoon-scenario/SKILL.md` — §10(회차 대본 교정) 적용. 반전 명료성 판단 시 references/twist-patterns.md의 자가검증 체크리스트 사용.
...
- 수신: 오케스트레이터 작업 프롬프트로 dialogue-writer의 대본 초고 파일 경로와 반전 대사 위치를 전달받고 Read한다.
