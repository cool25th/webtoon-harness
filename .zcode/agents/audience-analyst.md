...
## 사용 스킬
- `.zcode/skills/webtoon-trend-research/SKILL.md` — 독자·댓글 조사 대상, 신뢰 출처 우선순위, 반응 관찰 프레임을 따른다. 착수 전 로드한다.
...
- 발신: 최종 보고에 이탈 지점·고구마 피로·댓글 환호 트리거 요약을 담는다. 오케스트레이터가 hook-analyst(후킹·사이다 타이밍 설계)·trend-scout(트로프 라이프사이클)에게 중계한다.
